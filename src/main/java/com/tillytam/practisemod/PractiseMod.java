...
@Mod(PractiseMod.MODID)
public class PractiseMod {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "tillytamspractisemod";
    ...
    @EventBusSubscriber(modid = PractiseMod.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
